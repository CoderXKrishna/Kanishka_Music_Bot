...
1. Clone the repo
   ...
   ```sh
   git clone https://github.com/CoderXKrishna/Kanishka_Music_Bot
   ```
...
You've found a bug in the source code, a mistake in the documentation or maybe you'd like a new feature? You can help us by [submitting an issue on GitHub](https://github.com/CoderXKrishna/Kanishka_Music_Bot/issues). Before you create an issue, make sure to search the issue archive -- your issue may have already been addressed!
...
1. Search our repository for open or closed
   [Pull Requests](https://github.com/CoderXKrishna/Kanishka_Music_Bot/pulls)
...
6. [Open a Pull Request](https://github.com/CoderXKrishna/Kanishka_Music_Bot/compare?expand=1)
