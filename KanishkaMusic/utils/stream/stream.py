...
import config
from KanishkaMusic import Carbon, YouTube, app
from KanishkaMusic.core.call import Kanishka
from KanishkaMusic.misc import db
from KanishkaMusic.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from KanishkaMusic.utils.exceptions import AssistantErr
from KanishkaMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from KanishkaMusic.utils.inline.playlist import close_markup
from KanishkaMusic.utils.pastebin import Kanishkabin
from KanishkaMusic.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await Kanishka.force_stop_stream(chat_id)
