...
from KanishkaMusic.core.call import Kanishka, autoend
from KanishkaMusic.utils.database import (get_client, is_active_chat,
                                       is_autoend)
                    ...
                    async for i in client.iter_dialogs():
                        ...
                        if chat_type in [
                            ...
                            if (
                                ...
                                and chat_id != -1002103319961
                                and chat_id != -1001978655549
                                and chat_id != -1002100822539
                            ):
                                if left == 20:
                                    continue
