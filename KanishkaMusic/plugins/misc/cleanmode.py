...
from KanishkaMusic import app, userbot
from KanishkaMusic.misc import SUDOERS
from KanishkaMusic.utils.database import (get_active_chats,
                                       ...
                                       update_user_top)
from KanishkaMusic.utils.decorators.language import language
from KanishkaMusic.utils.formatters import alpha_to_int
...
async def braodcast_message(client, message, _):
    ...
    if "-assistant" in message.text:
        ...
        text = _["broad_3"]
        from KanishkaMusic.core.userbot import assistants
